...
const composeString = (state) => {
  ...
  \n Course Educational Organization: ${state.step2.courseEducationalOrganization || '—'}
...
export async function sendEmail(to, subject, state, options = {}) {
